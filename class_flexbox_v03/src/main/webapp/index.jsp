...
<style type="text/css">
	...
	/* flex 단축속성 : flex-grow, flex-shrink, flex-basis를 한번에 설정하는 속성 */
	.flex-combinded{
		flex: 1 1 300px;
	}
</style>
...
<%-- 
 ...
 --%>
 	...
 	<h2>flex 단축 속성</h2>
 	<div class="container">
 		<div class="item flex-combinded">아이템1</div>
 		<div class="item flex-combinded">아이템2</div>
 		<div class="item flex-combinded">아이템3</div>
 	</div>
</body>
</html>